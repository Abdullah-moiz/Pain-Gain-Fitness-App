...
export default function OrderDetails() {
    ...
    useEffect(() => {
        (async () => {
            try {
                let finalData = {id , status}
                await axios.put(`http://localhost:8000/ChangeOrderStatus`, finalData)
            } catch (error) {
                                    ...
                                    <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                                        <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                                            <div class="overflow-hidden">
                                                ...
                                                <div className='w-1/2   flex items-start flex-col justify-center p-2 m-2'>
                                                    <label htmlFor="" className='text-gray-700 font-semibold text-lg'>Action</label>
                                                    <select required name="" id="" className='w-full cursor-pointer' value={status} onChange={(e) => setStatus(e.target.value)}>
