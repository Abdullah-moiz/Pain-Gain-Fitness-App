...
export default function OrderDetails() {
    ...
    return (
        ...
        <div className='w-full h-full flex flex-col items-center justify-start p-4'>
            ...
            <h1 className='p-2 m-2 text-2xl font-semibold'>My Orders Details</h1>
            {
                data.map((item, i) => {
                    return (
                                                            ...
                                                            item.cart?.map((cartitem) => {
                                                                return (
                                                                    <tr className="border-b">
                                                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{(cartitem.product_name)}</td>
