...
export default function ADMINSupplierApplicationView() {
    ...
    useEffect(() => {
        (async () => {
            try {
                await axios.get(`http://localhost:8000/getAllApplications`).then(res => setData(res.data))
            } catch (error) {
    ...
    return (
        <div className="w-full h-full p-4">
            ...
            <h2 className='text-4xl font-semibold ml-4'>Suppliers Application</h2>
