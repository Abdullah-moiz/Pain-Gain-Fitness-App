...
export default function UserComplain() {
    ...
    useEffect(() => {
        (async () => {
            try {
                await axios.get(`http://localhost:8000/getspecificCusDetail` , {
    ...
    return (
        <div className="w-full h-full p-4">
            ...
            <h2 className='text-4xl font-semibold ml-4 pl-2'>My Complains List</h2>
                                ...
                                <tbody>
                                    {
                                        ...
                                        data.map((item) => {
                                            ...
                                            return (<tr className="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                                                ...
                                                <td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                    <button onClick={() => navigate(`cusComplainDetail/${id}`)} className='border-2 border-orange-600 rounded hover:text-white hover:bg-orange-600 transition-all duration-200 p-2'>View Detail</button>
                                                </td>
