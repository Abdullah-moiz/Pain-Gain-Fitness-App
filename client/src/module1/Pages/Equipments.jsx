...
export default function Equipments({machineData, getCardData}) {
  const [loaded, setloaded] = useState(false)
  const product = machineData;
    ...
    <div>
      ...
      <div className={`${loaded === true ? "flex" : "hidden"}  w-full  bg-white text-black flex-col `}>
        ...
        <div className='h-4/5 w-full flex items-start justify-center flex-wrap'>
          <h1 className='text-4xl text-black font-semibold p-2 m-4'>Equipments</h1>
